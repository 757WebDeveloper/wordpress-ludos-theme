...
if (!function_exists('ludos_paradise_trx_addons_get_css')) {
	add_filter('ludos_paradise_filter_get_css', 'ludos_paradise_trx_addons_get_css', 10, 4);
	function ludos_paradise_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.scheme_self.sidebar .widget_twitter .widget_content .sc_twitter_list li a,
.scheme_self.sidebar .widget_twitter .widget_content .sc_twitter_list li {
	color: {$colors['text']};
}
.scheme_self.sidebar .widget_twitter .widget_content .sc_twitter_list li a:hover,
