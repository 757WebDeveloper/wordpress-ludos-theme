...
// 'info' field
//--------------------------------------------------------------------
class Ludos_Paradise_Customize_Info_Control extends WP_Customize_Control {
	public $type = 'info';
...
// 'hidden' field
//--------------------------------------------------------------------
class Ludos_Paradise_Customize_Hidden_Control extends WP_Customize_Control {
	public $type = 'hidden';
	...
	public function render_content() {
		...
		if ($this->id=='last_option' && ludos_paradise_storage_get('need_footer_scripts', false)) {
			ludos_paradise_storage_set('need_footer_scripts', false);
...
// 'button' field
//--------------------------------------------------------------------
class Ludos_Paradise_Customize_Button_Control extends WP_Customize_Control {
	public $type = 'button';
...
// 'switch' field
//--------------------------------------------------------------------
class Ludos_Paradise_Customize_Switch_Control extends WP_Customize_Control {
	public $type = 'switch';
...
// 'icon' field
//--------------------------------------------------------------------
class Ludos_Paradise_Customize_Icon_Control extends WP_Customize_Control {
	public $type = 'icon';
	...
	public function render_content() {
		...
		ludos_paradise_show_layout(ludos_paradise_show_custom_field('_customize-icon-selector-'.esc_attr($this->id),
													array(
														'type'	 => 'icons',
														'button' => true,
														'icons'	 => true
...
// 'checklist' field
//--------------------------------------------------------------------
class Ludos_Paradise_Customize_Checklist_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		ludos_paradise_show_layout(ludos_paradise_show_custom_field('_customize-checklist-'.esc_attr($this->id),
...
// 'scheme_editor' field
//--------------------------------------------------------------------
class Ludos_Paradise_Customize_Scheme_Editor_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		?><span class="customize-control-field-wrap"><input type="hidden" <?php $this->link(); ?> /><?php
		ludos_paradise_show_layout(ludos_paradise_show_custom_field('_customize-scheme-editor-'.esc_attr($this->id),
													$this->input_attrs,
													ludos_paradise_unserialize($this->input_attrs['value'])
													)
							);
		?></span></div><?php
	}
...
// 'text_editor' field
//--------------------------------------------------------------------
class Ludos_Paradise_Customize_Text_Editor_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		ludos_paradise_show_layout(ludos_paradise_show_custom_field('_customize-text-editor-'.esc_attr($this->id),
			$this->input_attrs,
			$this->input_attrs['value']
			)
		);
		...
		ludos_paradise_storage_set('need_footer_scripts', true);
	}
}
...
// 'range' field
//--------------------------------------------------------------------
class Ludos_Paradise_Customize_Range_Control extends WP_Customize_Control {
	public $type = 'range';
	...
	public function render_content() {
		...
		?><span class="customize-control-field-wrap"><input type="<?php echo !$show_value ? 'hidden' : 'text'; ?>" <?php 
			$this->link();
			if ($show_value) echo ' class="ludos_paradise_range_slider_value"';
		?> /><?php
		ludos_paradise_show_layout(ludos_paradise_show_custom_field('_customize-range-'.esc_attr($this->id),
													$this->input_attrs,
													$this->input_attrs['value']
													)
							);
