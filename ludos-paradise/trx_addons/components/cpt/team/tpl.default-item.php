...
<div <?php post_class( 'sc_team_item' . (empty($post_link) ? ' no_links' : '') ); ?>>
	...
	<div class="sc_team_item_info">
		...
		if (!empty($link)) {
			?><div class="sc_team_item_button"><a href="<?php echo esc_url($link); ?>" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'sc_button sc_button_simple', 'sc_team', $args)); ?>"><?php esc_html_e('Learn more', 'ludos-paradise'); ?></a></div><?php
		}
	?></div>
</div><?php
