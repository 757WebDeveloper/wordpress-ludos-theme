    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class( 'sport_single player_single itemscope' ); trx_addons_seo_snippets('', 'Article'); ?>>
				...
				?><div class="sport_page_meta"><?php
					...
					if (!empty($meta['birthday'])) {
						?><div class="sport_page_meta_item sport_page_meta_date">
							<span class="sport_page_meta_item_label"><?php esc_html_e('Birthday:', 'ludos-paradise'); ?></span>
					...
					if (!empty($meta['club'])) {
						?><div class="sport_page_meta_item sport_page_meta_club">
							<span class="sport_page_meta_item_label"><?php esc_html_e('Club/Country:', 'ludos-paradise'); ?></span>
							<span class="sport_page_meta_item_value"><?php
					...
					if (!empty($meta['info'])) {
						?><div class="sport_page_meta_item sport_page_meta_info">
							<span class="sport_page_meta_item_label"><?php esc_html_e('Brief info:', 'ludos-paradise'); ?></span>
							<span class="sport_page_meta_item_value"><?php
		...
		<div class="sport_page_lists competition_page_lists">
			...
			?><div class="sport_page_list_wrap sport_page_rounds">
				<h3 class="sport_page_list_header"><?php esc_html_e("List of matches with this player", 'ludos-paradise'); ?></h3>
				<ul class="sport_page_list">
					<li><?php
						?><span class="sport_page_list_title sport_page_match_round"><?php esc_html_e('Round', 'ludos-paradise'); ?></span><?php
						?><span class="sport_page_list_title sport_page_match_date"><?php esc_html_e('Date', 'ludos-paradise'); ?></span><?php
					...
					foreach ($matches as $id_match=>$name_match) {
						...
						?><li><?php
								...
								if (isset($meta['player1'])) {
									...
									// Score
									?><span class="sport_page_match_score"><a href="<?php echo esc_url($link); ?>"><?php
												if (is_rtl())
												{
													if ( empty($meta['score']) )
													{
