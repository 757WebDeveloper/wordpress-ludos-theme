    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class( 'sport_single competition_single itemscope' ); trx_addons_seo_snippets('', 'Article'); ?>>
		...
		<div class="sport_page_lists competition_page_lists">
			...
			?><div class="sport_page_list_wrap sport_page_rounds">
				<h3 class="sport_page_list_header"><?php esc_html_e("List of the competition's rounds", 'ludos-paradise'); ?></h3>
			...
			?><div class="sport_page_list_wrap sport_page_players">
				<h3 class="sport_page_list_header"><?php esc_html_e("Table of the players points", 'ludos-paradise'); ?></h3>
				<ul class="sport_page_list">
					<li><?php
						...
						?><span class="sport_page_list_title sport_page_player_games"><?php esc_html_e('Games', 'ludos-paradise'); ?></span><?php
