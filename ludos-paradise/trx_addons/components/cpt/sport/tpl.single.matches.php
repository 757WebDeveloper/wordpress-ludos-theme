				...
				<div class="sport_page_meta">
					<span class="sport_page_meta_item sport_page_meta_date"><?php
						...
						echo sprintf($dt < date('Y-m-d') 
										? esc_html__('Started on %s', 'ludos-paradise')
										: esc_html__('Starting %s', 'ludos-paradise'),
		...
		?><div class="sport_page_lists match_page_lists"><?php
			...
			if (isset($meta['players'])) {
				...
				?><div class="sport_page_list_wrap sport_page_players">
					<h3 class="sport_page_list_header"><?php esc_html_e("List of players of the current match", 'ludos-paradise'); ?></h3>
					<ul class="sport_page_list">
						<li><?php
							?><span class="sport_page_list_title sport_page_player_rank"><?php esc_html_e('Rank', 'ludos-paradise'); ?></span><?php
							?><span class="sport_page_list_title sport_page_player_logo"><?php esc_html_e('Logo', 'ludos-paradise'); ?></span><?php
							?><span class="sport_page_list_title sport_page_player_name"><?php esc_html_e('Player/Command (Club/Country)', 'ludos-paradise'); ?></span><?php
							?><span class="sport_page_list_title sport_page_player_points"><?php esc_html_e('Points', 'ludos-paradise'); ?></span>
						</li>
						<?php
						$rank = 1;
			...
			if (count($matches) > 0) {
				?><div class="sport_page_list_wrap sport_page_matches">
					<h3 class="sport_page_list_header"><?php esc_html_e("Other matches in this round", 'ludos-paradise'); ?></h3>
					<ul class="sport_page_list">
						<li><?php
							?><span class="sport_page_list_title sport_page_match_time"><?php esc_html_e('Time', 'ludos-paradise'); ?></span><?php
							?><span class="sport_page_list_title sport_page_match_name"><?php esc_html_e('Match', 'ludos-paradise'); ?></span>
						</li>
						<?php
						$last_date = '';
						foreach ($matches as $id_match=>$name_match) {
							...
							?><li><a href="<?php the_permalink($id_match); ?>" class="sport_page_list_link"><?php
								...
								if (isset($meta['player1'])) {
									...
									// Score
									?><span class="sport_page_match_score"><?php
											if (is_rtl())
											{
												if ( empty($meta['score']) )
												{
													echo esc_html__('--:--', 'ludos-paradise');
												}
												else
												{
											...
											{
												echo empty($meta['score']) ? esc_html__('--:--', 'ludos-paradise') : $meta['score'];
											}
										?></span><?php
