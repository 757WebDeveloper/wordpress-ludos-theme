...
?><div class="sc_matches_item"><a href="<?php the_permalink($match['id']); ?>" class="sc_matches_item_link"><?php
	...
	?><div class="sc_matches_item_info"><?php
		...
		if (isset($meta['player1'])) {
			...
			// First player
			?><div class="sc_matches_item_name1">
			...
			?><span class="sc_matches_item_score1"><?php esc_html_e('vs', 'ludos-paradise'); ?></span><?php
            ...
            ?><div class="sc_matches_item_name2">
	...
	?></div><?php
		...
		<span class="sc_matches_item_day"><?php echo date_i18n("H:i / M d, Y", strtotime($meta['date_start'])); ?></span>
	</span></div><?php
?></a></div>