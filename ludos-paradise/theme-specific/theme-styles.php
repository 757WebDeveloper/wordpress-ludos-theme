...
if (!function_exists('ludos_paradise_customizer_get_css')) {

	function ludos_paradise_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = ludos_paradise_customizer_add_theme_fonts($fonts);
...
.ludos_paradise_tabs .ludos_paradise_tabs_titles li a {
...
EOT;
			$rez = apply_filters('ludos_paradise_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
EOT;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(ludos_paradise_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = ludos_paradise_get_scheme_colors($scheme);
...
.scheme_self.sc_content_bordered > .sc_content_container {
    background-color: {$colors['bg_color']};
}
/* Header */
.top_panel,
...
.ludos_paradise_tabs .ludos_paradise_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.ludos_paradise_tabs .ludos_paradise_tabs_titles li.ui-state-active a {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
...
.sheme_self.sidebar .ludos_paradise_tabs .ludos_paradise_tabs_titles li a {
	color: {$colors['alter_dark']};
	background-color: {$colors['alter_bg_hover']};
}
.sheme_self.sidebar div.esg-filter-wrapper .esg-filterbutton > span:hover,
.sheme_self.sidebar .mptt-navigation-tabs li a:hover,
.sheme_self.sidebar .ludos_paradise_tabs .ludos_paradise_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_link']};
}
...
.sheme_self.sidebar .ludos_paradise_tabs .ludos_paradise_tabs_titles li.ui-state-active a {
...
.sidebar[class*="scheme_"] .widget .widget_title a {
	border-color: {$colors['bd_color']};
	color: {$colors['text']};
}
.sidebar[class*="scheme_"] .widget .widget_title a:hover {
	color: {$colors['text_hover']};
}
...
.widget_calendar .calendar_wrap span a:hover:before {
	color: {$colors['alter_hover']};
}
.footer_wrap .widget_calendar .calendar_wrap span a:before {
	color: {$colors['text_dark']};
}
.footer_wrap .widget_calendar .calendar_wrap span a:hover:before {
	color: {$colors['text_link']};
}
.scheme_self.sidebar .wp-block-calendar .wp-calendar-nav .wp-calendar-nav-prev a:before,
...
.scheme_self.footer_wrap .wp-block-calendar .wp-calendar-nav .wp-calendar-nav-prev a:before,
.scheme_self.footer_wrap .wp-block-calendar .wp-calendar-nav .wp-calendar-nav-next a:before,
.scheme_self.footer_wrap .widget_calendar .wp-calendar-nav .wp-calendar-nav-prev a:before,
.scheme_self.footer_wrap .widget_calendar .wp-calendar-nav .wp-calendar-nav-next a:before,
...
.woocommerce table.my_account_orders .woocommerce-orders-table__cell a:hover,
...
EOT;
					...
					$rez = apply_filters('ludos_paradise_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'ludos_paradise_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>